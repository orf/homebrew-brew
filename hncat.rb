class Hncat < Formula
  ...
  if OS.mac?
    url "https://github.com/orf/hncat/releases/download/hncat-v0.1.3/hncat-Darwin-x86_64.tar.gz"
    sha256 "0d8198f569d3bd294dcc036fefed0987ab39a28d2666d1080c6541879a3ca24f"
  elsif OS.linux?
    url "https://github.com/orf/hncat/releases/download/hncat-v0.1.3/hncat-Linux-x86_64.tar.gz"
