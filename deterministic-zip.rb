class DeterministicZip < Formula
  ...
  if OS.mac?
    url "https://github.com/orf/deterministic-zip/releases/download/v0.0.4/deterministic-zip-Darwin-x86_64.tar.gz"
    sha256 "0eed9e5a5d3709b0b4170454cdef41cb0ae691794753e78b5eb4c83438fedb3e"
  elsif OS.linux?
    url "https://github.com/orf/deterministic-zip/releases/download/v0.0.4/deterministic-zip-Linux-x86_64.tar.gz"
